...
function calc() {
  ...
  function inutLocalSettings(selector, activeClass) {
  ...
  inutLocalSettings('#gender div', 'calculating__choose-item_active');
  inutLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active');
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    updateClock(); // убираем мерцание даты из верстки
